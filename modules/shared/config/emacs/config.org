...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Jason Huang"
    user-mail-address "jasonhuang20035@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/jason/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/jason/bin" "/profile/bin" "/Users/jason/.npm-packages/bin" "/Users/jason/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
